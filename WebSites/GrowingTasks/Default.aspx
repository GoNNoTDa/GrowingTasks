...
<body class="wrap">
    ...
    <a href="Default.aspx" id="logo"><img src="images/icebrrrg-logo.png" alt="Icebrrrg logo" height="63" width="157" /></a>
    </h1>
    </hgroup>
    ...
    <li id="menu-item-2">
    <a href="three-column.aspx">Three Column</a>
    </li>
    <li id="menu-item-3">
    <a href="sidebar-right.aspx">Sidebar Right</a>
    </li>
    <li id="menu-item-4">
    <a href="sidebar-left.aspx">Sidebar Left</a>
    </li>
    <li id="menu-item-5">
    <a href="full-width.aspx">Full Width</a>
    </li>
    <li id="menu-item-6">
