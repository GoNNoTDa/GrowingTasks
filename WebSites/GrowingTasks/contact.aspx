<%@ Page Language="C#" AutoEventWireup="true" CodeFile="contact.aspx.cs" Inherits="contact"
    MasterPageFile="~/MasterPage.master" Title="contact" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="container">
        <article class="ten columns main-content">
            <h1>
                We like it when people send us messages</h1>
            <div id="message">
            </div>
            ...
            <fieldset>
                ...
                <p>
                    <span class="required">*</span> Are you human?</p>
                <label for="verify" class="verify-this" accesskey="V">
                    &nbsp;&nbsp;&nbsp;3 + 1 =</label>
                <input name="verify" type="text" id="verify" class="verify-this" size="4" value=""
                    style="width: 30px;" /><br />
                <br />
